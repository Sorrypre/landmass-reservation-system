...
generate_dialog_profile_info_reset_warning();

const generate_dialog_delete_account_warning = function(){
const msg = `
    <!-- https://uxwing.com/warning-icon/ -->
    <svg class="page-dialog-icon" id="warning" data-name="warning" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 111.54">
    <defs>
...
`;
const res = `
    <button type="button" target-dialog-command="close" target-dialog-id="profile-deletion-warning" class="page-dialog-message-button after:content-['OK'] text-black"></button>
`;
...
generate_dialog_delete_account_warning();